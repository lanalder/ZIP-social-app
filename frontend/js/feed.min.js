...
$(document).ready(function(){let o,i=new Array(4),t={},l,r={get id(){return sessionStorage.getItem("user_id")},get name(){return sessionStorage.getItem("username")}},s=new Map;const n=["title","img_url","descript","user_id"],c=document.querySelector("#albumOutput");$.ajax({url:"config.json",type:"GET",dataType:"json",success(e){o=`${e.SERVER_URL}:${e.SERVER_PORT}`,f()},error(e){console.log(e)}});const a=()=>r.id?i.every(e=>e):(alert("Please login to perform this action"),!1),d=()=>{for(let e=0;e<4;e++)Object.defineProperty(t,n[e],{value:i[e],enumerable:!0,configurable:!0})},m=(e,t)=>{$.ajax({url:e,type:"GET",dataType:"json",success(e){t(e)},error(e){console.log(e)}})},u=(e,t,i,n)=>{$.ajax({url:e,type:t,dataType:"json",data:JSON.stringify(i),contentType:"application/json",success(e){n(e)},error(e){console.log(e)}})},f=()=>{m(`${o}/allPosts`,function(t){r.id?m(`${o}/hasLiked/${r.id}`,function(e){e=e.map(e=>Object.values(e)).flat(),p(t,e)}):p(t,!1)})},p=(t,i)=>{let n,a;c.innerHTML="";for(let e=t.length-1;e>=t.length-20;--e){var o=t[e],s=t[e].author[0];n=i&&i.includes(o._id)?"fa-heart active-icon":"fa-heart-o",a=r.id!==o.user_id?"display-none":"",c.innerHTML+=`<div class="col-md-4">
          ...
          <div class="card-img-overlay d-flex">
            ...
            <div class="col-8 overlay-container d-flex justify-content-center">
              ...
              <div class="overlay-text-container">
                <a href="myprofile.html#${o.user_id}"><h4 class="overlay-username d-block">${s.username}</h4></a>
        ...
        </div>`,document.querySelector(".post-comment").addEventListener("click",function(e){((t,i)=>{if(r.id){const e=s.get(t.classList[0])+1;s.set(t.classList[0],e);u(`${o}/createComment`,"POST",{author:r.name,text:document.querySelector("#newComment").value,user_id:r.id,post_id:t.classList[0]},function(){const e=parseInt(i.innerText)+1;i.innerHTML=`<p class="${t.classList[0]} comment interaction-icon comment-counter interaction-icon"><i class="${t.classList[0]} comment fa fa-commenting-o" aria-hidden="true"></i> ${e}</p>`;v(i)})}else alert("Please login or register to interact with posts :)")})(e.target,n)},!0))})};document.querySelector("#addConfirmBtn").addEventListener("click",function(e){Array.from(document.querySelectorAll(".addField")).forEach((e,t)=>{i[t]=$(e).val()}),i[3]=r.id,d(),a()?u(`${o}/postPost`,"POST",t,function(e){e?(alert("Your project has been successfully added!"),setTimeout(function(){window.location.reload()},1e3)):alert("You are not authorised to perform this action")}):alert("Please fill out all fields")},!1),document.querySelector("#editConfirmBtn").addEventListener("click",function(e){Array.from(document.querySelectorAll(".editField")).forEach((e,t)=>{i[t]=$(e).val()}),i[3]=r.id,d(),a()?u(`${o}/editPost/${l}`,"PATCH",t,function(e){"401: user has no permission to update"==e?alert(e):(alert("Post has been updated"),window.location.reload())}):alert("Please fill in all fields")},!1),document.querySelector("#deleteConfirmBtn").addEventListener("click",function(e){r.id?$.ajax({url:`${o}/deletePost/${l}`,type:"DELETE",data:{user_id:r.id},success(e){"deleted"==e?(alert("Post has been deleted"),window.location.reload()):alert("Post was not found")},error(e){console.log(e)}}):alert("You do not have permission to delete this post")},!1);const g=e=>{document.querySelector(".fullImage").src=e.parentElement.parentElement.parentElement.firstElementChild.src,document.querySelector(".view-title").innerHTML=e.parentElement.nextElementSibling.lastElementChild.lastElementChild.innerText}});